...
<head>
    ...
    <title>{{ app()->getLocale() === 'en' ? 'Server Error — WhatsAppBizAI' : 'Erreur serveur — WhatsAppBizAI' }}</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-size: 100px; font-weight: 900; color: #ef4444; line-height: 1; }
...
<body>
    <div>
        <h1>500</h1>
        <h2>{{ app()->getLocale() === 'en' ? 'Server Error' : 'Erreur serveur' }}</h2>
        <p>{{ app()->getLocale() === 'en' ? 'An internal error occurred. Our team has been notified.' : 'Une erreur interne s\'est produite. Notre équipe a été notifiée.' }}</p>
