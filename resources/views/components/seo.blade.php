...
$faqJson = [
    ...
    'mainEntity' => [
        ...
        ['@type' => 'Question', 'name' => $isFr ? 'Combien coûte WhatsAppBizAI ?' : 'How much does WhatsAppBizAI cost?', 'acceptedAnswer' => ['@type' => 'Answer', 'text' => $isFr ? 'WhatsAppBizAI propose un plan gratuit pour démarrer, sans carte bancaire requise. Les plans Starter et Business sont disponibles à partir de 4 900 XAF/mois.' : 'WhatsAppBizAI offers a free plan to get started, no credit card required. Starter and Business plans are available from 4,900 XAF/month.']],
